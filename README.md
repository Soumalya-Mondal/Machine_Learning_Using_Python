# Prefix I use "Hu-Ho" for 'Human-Horse Code' and "C-D" for 'Cat-Dog Code'
# There are three steps and you have to follow this 1-'prefix'-image_train.py 2-'prefix'-model_train.py 3-'prefix'-load_model.py
